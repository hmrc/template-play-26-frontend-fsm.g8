...
class $servicenameCamel$FormSpec extends UnitSpec {

  val formOutput = $servicenameCamel$Model(
    nino = Nino("RJ301829A"),
    givenName = "Jan",
    familyName = "Kowalski",
  ...
  "StatusCheckByNinoRequestForm" should {
    ...
    "bind some input fields and return StatusCheckByNinoRequest and fill it back" in {
      val form = $servicenameCamel$FrontendController.$servicenameCamel$Form
